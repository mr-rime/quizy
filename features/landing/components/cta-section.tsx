    ...
    return (
        <section className="container mx-auto px-4 py-24">
            <div className="relative rounded-3xl bg-indigo-600 overflow-hidden px-6 py-20 text-center">
                ...
                <div className="absolute -top-24 -left-24 w-64 h-64 bg-white/20 rounded-full blur-3xl transform-gpu"></div>
                <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-indigo-900/50 rounded-full blur-3xl transform-gpu"></div>
