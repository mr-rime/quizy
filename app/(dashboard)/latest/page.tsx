...
const getLatestData = cache(async () => {
    ...
    const [recentSets, progressSessions, user, stats] = await Promise.all([
    ...
    return { recentSets, progressSessions, user, stats };
});

export default async function LatestPage() {
    const { recentSets, progressSessions, user, stats } = await getLatestData();
